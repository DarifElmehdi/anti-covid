...
export default function Covid() {
    return (
        ...
        <Card className="text-white">
            <Image src="assets/banner.jpg" alt="Card image"/>
            <Card.ImgOverlay>
        ...
        <div class="col-md-5">
        <Image src="assets/covid01.jpg" width="100%"/> 
        </div>
        </div>


        <div>
        <h2 class="featurette-heading text-left">Comment le virus responsable de la COVID-19 se transmet-il d’une personne à l’autre ?</h2>
        ...
        <br/>
        <br/>
        <Image src="assets/covid02.jpg" width="100%"/> 
        </div>
        </div>
        ...
        <br/>
        <br/>
        <Image src="assets/covid03.jpg" width="100%"/> 
        </div>
        </div>
        ...
        <br/>
        <br/>
        <Image src="assets/covid04.jpg" width="100%"/> 
        </div>
        </div>
        ...
        <br/>
        <br/>
        <Image src="assets/covid05.jpg" width="100%"/> 
        </div>
        </div>
    </div>
    </div>
